...
import icon5 from "../assets/facebook.svg";
import icon6 from "../assets/instagram.svg";
import icon7 from "../assets/pinterest.svg";
import icon8 from "../assets/twitter.svg";
        ...
        <div className={styles.footer}>
            ...
            <div className={styles.endinfo}>
                ...
                <div className={styles.info}>
                    <h3>CONTACT</h3>
                    <p>Manorama Junction, Panampilly Nagar, Ernakulam, Kerala, India, Pin Code: 682036
                        +91 12345 67890
                        info@foodlecafe.com
                    </p>
                </div>
